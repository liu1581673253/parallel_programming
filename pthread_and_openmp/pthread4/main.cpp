...
void* thread_func(void* args){
    ...
    auto pointer = (thread_arg*) args;

    for(int i=pointer->idx_b;i<pointer->idx_e;i++){
        //找出最短的表
...
int main()
{
    ...
    thread_arg arg1={0,250};
    thread_arg arg2={250,500};
    thread_arg arg3={500,750};
    thread_arg arg4={750,1000};
